...
export function LanguageProvider({ children }: { children: React.ReactNode }) {
  ...
  const flatFallbacks: Record<string, Record<string, string>> = {
    am: {
      ...
      rating_breakdown: 'የደረጃ ስርጭት',
      stars: 'ኮከቦች',
      star: 'ኮከብ',
      out_of_5: 'ከ 5',
      based_on_reviews: 'አስተያየቶች ላይ የተመሰረተ',
      my_reviews: 'የእኔ አስተያየቶች',
      view_all_reviews_desc: 'የሰጧቸውን ግምገማዎች እና አስተያየቶች ይመልከቱ',
      edit_review: 'አስተያየት አርትዕ',
      update_review: 'አስተያየት አድስ',
      delete_review: 'አስተያየት ሰርዝ',
      delete_review_confirm: 'ይህን አስተያየት በእርግጥ መሰረዝ ይፈልጋሉ?',
      already_reviewed: 'ይህን ምርት አስቀድመው ገምግመዋል',
      review_eligible_after_delivery: 'ትዕዛዝዎ ከደረሰ በኋላ ይህንን ምርት መገምገም ይችላሉ',
      not_purchased_to_review: 'ይህንን ምርት የገዙ እና የተቀበሉ ደንበኞች ብቻ አስተያየት መጻፍ ይችላሉ',
      pending_moderation: 'በግምገማ ላይ',
      approved_published: 'የታተመ',
      admin_response: 'የአርዳብ ገበያ ምላሽ',
      review_title: 'ርዕስ (አማራጭ)',
      review_placeholder: 'ስለ ምርቱ ጥራት እና አገልግሎት ያለዎትን አስተያየት ያጋሩ...',
      saving: 'በማስቀመጥ ላይ...',
      anonymous_review: 'ስሜ እንዳይታይ አድርግ',
      your_review: 'የእርስዎ አስተያየት',
      about: 'ስለ እኛ',
      ...
      support: 'የደንበኞች ድጋፍ',
      customer_support: 'የደንበኞች ድጋፍ አገልግሎት',
      help_center: 'የእርዳታ ማዕከል',
      help_center_subtitle: 'ጥያቄዎች ወይም እርዳታ የሚያስፈልግዎት ነገር አለ? እኛን ለማግኘት አያመንቱ።',
      my_support_requests: 'የድጋፍ ጥያቄዎቼ',
      my_support_requests_subtitle: 'የድጋፍ ጥያቄዎችዎን ሂደት እና ምላሾች እዚህ ይከታተሉ',
      new_support_request: 'አዲስ የድጋፍ ጥያቄ',
      new_support_request_subtitle: 'እርዳታ የሚፈልጉትን ጉዳይ ይግለጹልን፤ ቡድናችን በፍጥነት ምላሽ ይሰጥዎታል',
      contact_support: 'ድጋፍ ይጠይቁ',
      contact_support_desc: 'በቀጥታ ከአርዳብ የድጋፍ ቡድን ጋር ይገናኙ',
      request_number: 'የጥያቄ ቁጥር',
      subject: 'ርዕስ',
      enter_subject: 'የጉዳዩን አጭር ርዕስ ያስገቡ...',
      message: 'መልዕክት',
      enter_message: 'ጉዳይዎን በዝርዝር ይግለጹልን...',
      select_category: 'ምድብ ይምረጡ',
      select_order_optional: 'ተዛማጅ ትዕዛዝ ይምረጡ (አማራጭ)',
      no_order_related: 'ከተለየ ትዕዛዝ ጋር አይገናኝም',
      priority: 'አስቸኳይነት',
      priority_low: 'ዝቅተኛ',
      priority_normal: 'መደበኛ',
      priority_high: 'ከፍተኛ',
      priority_urgent: 'በጣም አስቸኳይ',
      status: 'ሁኔታ',
      status_open: 'ክፍት',
      status_in_progress: 'በሂደት ላይ',
      status_waiting_for_customer: 'የእርስዎን ምላሽ በመጠባበቅ ላይ',
      status_resolved: 'ተፈትቷል',
      status_closed: 'ተዘግቷል',
      status_all: 'ሁሉም',
      send_request: 'ጥያቄውን ላክ',
      reply_to_ticket: 'ምላሽ ይስጡ',
      write_reply: 'ምላሽዎን እዚህ ይጻፉ...',
      send_reply: 'ምላሽ ላክ',
      conversation_history: 'የውይይት ታሪክ',
      unread_reply: 'አዲስ ምላሽ አለ',
      no_support_requests: 'እስካሁን ምንም የድጋፍ ጥያቄ አላቀረቡም።',
      no_support_requests_desc: 'ማናቸውም ጥያቄ ወይም ችግር ካጋጠመዎት አዲስ ጥያቄ በመፍጠር እኛን ማነጋገር ይችላሉ።',
      loading_support: 'የድጋፍ መረጃዎች በመጫን ላይ...',
      error_loading_support: 'የድጋፍ መረጃዎችን መጫን አልተቻለም።',
      retry: 'እንደገና ይሞክሩ',
      ticket_closed_notice: 'ይህ የድጋፍ ጥያቄ ተዘግቷል። ተጨማሪ እርዳታ ካስፈለገዎት አዲስ ጥያቄ ይክፈቱ።',
      ticket_resolved_notice: 'ይህ የድጋፍ ጥያቄ ተፈትቷል። ተጨማሪ እርዳታ ካስፈለገዎት እባክዎ አዲስ ጥያቄ ይክፈቱ።',
      support_hours_info: 'የአርዳብ ድጋፍ ቡድን በሳምንት 7 ቀናት አገልግሎት ይሰጣል።',
      view_conversation: 'ውይይቱን ይመልከቱ',
      support_categories: 'የድጋፍ መስኮች',
      quick_help_areas: 'ፈጣን የእርዳታ አርዕስቶች',
    ...
    en: {
      ...
      view_all_reviews_desc: 'View and manage all your product reviews',
      edit_review: 'Edit Review',
      update_review: 'Update Review',
      delete_review: 'Delete Review',
      delete_review_confirm: 'Are you sure you want to delete this review?',
      already_reviewed: 'You have already reviewed this product',
      review_eligible_after_delivery: 'You can review this product after your order has been delivered',
      not_purchased_to_review: 'Only verified buyers who received this item can write a review',
      pending_moderation: 'Pending Moderation',
      approved_published: 'Published',
      admin_response: 'Official Ardab Response',
      review_title: 'Review Title (Optional)',
      review_placeholder: 'Share your honest experience with this product...',
      saving: 'Saving...',
      anonymous_review: 'Submit anonymously',
      ...
      help_center_subtitle: 'Have questions or need assistance? We are here to help you.',
      my_support_requests: 'My Support Requests',
      my_support_requests_subtitle: 'Track your support conversations, tickets, and staff replies here',
      new_support_request: 'New Support Request',
      new_support_request_subtitle: 'Describe your issue and our team will get back to you promptly',
      contact_support: 'Contact Support',
      contact_support_desc: 'Connect directly with the Ardab support team',
      request_number: 'Ticket #',
      subject: 'Subject',
      enter_subject: 'Brief summary of your inquiry...',
      message: 'Message',
      enter_message: 'Describe your issue or inquiry in detail...',
      select_category: 'Select Category',
      select_order_optional: 'Related Order (Optional)',
      no_order_related: 'Not related to a specific order',
      priority: 'Priority',
      priority_low: 'Low',
      ...
      status_waiting_for_customer: 'Waiting on You',
      status_resolved: 'Resolved',
      status_closed: 'Closed',
      status_all: 'All',
      send_request: 'Send Request',
      reply_to_ticket: 'Reply to Ticket',
      write_reply: 'Type your reply here...',
      send_reply: 'Send Reply',
      conversation_history: 'Conversation Thread',
      unread_reply: 'New Reply',
      no_support_requests: "You haven't contacted Ardab Support yet.",
      no_support_requests_desc: 'If you have any questions or need help with an order, create a ticket to get started.',
      loading_support: 'Loading support details...',
      error_loading_support: "We couldn't load your support requests.",
      retry: 'Try again',
      ticket_closed_notice: 'This support ticket is closed and cannot receive new replies. Please create a new ticket if you need further help.',
      ticket_resolved_notice: 'This support ticket is resolved. If you require further assistance, please open a new ticket.',
      support_hours_info: 'Ardab Customer Support is active 7 days a week.',
      view_conversation: 'View Conversation',
      support_categories: 'Support Categories',
      quick_help_areas: 'Common Support Areas',
    },
  };
